...
// import components
import SignT from "./SignUp/signup-proceed/Signup-tres";
import SignCu from "./SignUp/signup-proceed/Signup-cuatro";

// Import images
import icon from "../images/icon.svg";
import bizDetail from "../images/signup-biz-det.svg";
import username from "../images/signup-username.svg";
...
export default function Main(props) {
  ...
  const [dos, dosText] = useState({
    ...
    body: "Provide your required business details for your account.",
  });
  ...
  const update = (n) => {
    switch (n) {
      ...
      case "sgn-Cu":
        ...
        dosText({
          head: "Set up your username",
          body: null,
        });
        break;
      case "success":
        props.updateMain("success");
        break;
      default:
        alert("error");
        break;
  ...
  const [curr, setCurr] = useState(<SignT dos={dos} update={update} />);
